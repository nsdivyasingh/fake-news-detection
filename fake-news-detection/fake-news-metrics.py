...
upload_csv_button = create_button(button_frame, "📂 Upload CSV", upload_csv_data, "#D1E9F6", "#333", "#A7CCEC")
upload_csv_button.grid(row=0, column=4, padx=10)
add_tooltip(upload_csv_button, "Import labeled data to calculate metrics")
